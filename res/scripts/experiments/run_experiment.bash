...
#if [ -z "$SLURM_ARRAY_TASK_ID" ]; then SLURM_ARRAY_TASK_ID=$1; fi
...
#echo "Running experiment with index: $SLURM_ARRAY_TASK_ID, params: $PARAMS"
...
#$JAVA_BIN -Xmx32g -jar ${APP_JAR} ${PARAMS} ${SLURM_ARRAY_TASK_ID} ${SAVE_FOLDER}
